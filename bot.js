...
bot.on('message', function (message) {
    ...
    if(msg.startsWith(prefix + 'play')){
        ...
        if(skippers.indexOf(message.author.id) == -1){
            ...
            skipReq++;
            if(skipReq >= ((Math.ceil((voiceChannel.members.size - 1)) / 2)) - skipReq) {
                skip_song(message);
            ...
            message.reply(' your skip has been added. You need ***' + Math.ceilMath.ceil((voiceChannel.members.size - 1) / 2) - skipReq) + "*** more votes to skip.";
        }
        }
